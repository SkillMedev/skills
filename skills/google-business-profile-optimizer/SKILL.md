...
extra customer from the profile is worth about $450 in first-job cash against
a roughly $119 paid CAC, so free GBP calls are the cheapest customers the
...
Confirm the owner controls the profile with a verified Google account. Search
the business name and phone number for duplicate profiles; duplicates split
...
service: Summit chooses "Plumber," not "Contractor." Add secondary categories
for real service lines only (for Summit: "Drainage service," "Water heater
installation and repair service"). Test one primary-category change at a time
and wait two to three weeks before judging, because rankings reshuffle after a
change.

### Step 3: Configure the service area correctly
...
Anyone can ask and answer questions on the profile, so the owner should ask
and answer the ten questions customers actually call with, before a stranger
answers wrong. Seed pairs like:
...
Collect: trade and highest-revenue service, walk-in location or service-area
business, exact legal and DBA name, cities genuinely served, top ten customer
questions, and who on staff can own the weekly photo/post routine. Default the
photo cadence to weekly and posts to weekly if the owner has no preference.
If the owner guesses which service earns most, label it a guess and verify
against job records before locking the primary category.

## Concrete thresholds

- Primary category: exactly one, the most specific match; re-judge any change
  only after two to three weeks.
- Photos: 3-5 new per week, minimum 1; a profile stale for 30+ days is
...
```
Business name:      Summit Plumbing        (exact legal DBA, no keywords)
Primary category:   Plumber
Secondary:          Drainage service; Water heater installation and
                    repair service
Type:               Service-area business, address hidden
Service area:       [Metro city] + Ridgefield, Oak Hill, Brookside,
                    Fairview, Lakemont, Cedar Falls
Hours:              Mon-Sat 7:00-19:00, 24/7 emergency line noted
                    in description
Description opens:  "Summit Plumbing is a residential plumbing company
                    serving [Metro city] with same-day drain, water
                    heater, and repair service..."
Weekly routine:     Fri: upload 3-5 tech job photos, publish 1 post,
                    answer any new Q&A
```

Bad contrast: name "Summit Plumbing | #1 Emergency Plumber [Metro]", primary
category "Contractor," a 50-mile radius, and 40 photos uploaded once in
January. That profile is a suspension risk that ranks worse each month.

## Deliverable

A completed profile audit against the checklist above, the exact category and
service-area settings to apply, seeded Q&A pairs, and a one-page weekly
routine (photos, post, Q&A check) with a named owner on staff.
...
- Do not change multiple ranking-relevant settings in the same week; you
  will not know which change moved the needle.

## Quality bar

- Checklist items resolved in impact order; no step marked done without the
  exact value set (category name, cities, hours).
- NAP verified character-identical across GBP and the website.
- The weekly routine names a specific person and a specific day.
- Any category change logged with a date and a re-check scheduled two to
  three weeks out.
