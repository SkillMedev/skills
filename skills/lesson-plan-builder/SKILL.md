...
| Direct instruction   | [FILL: <=15] min| [FILL: model + worked example]            | [FILL]    |
| Guided practice      | [FILL] min      | [FILL: students doing, teacher circulating]| [FILL]   |
| Independent practice | [FILL] min      | [FILL]                                    | [FILL]    |
| Closure              | [FILL: 3-5] min | [FILL: synthesis prompt]                  | [FILL]    |

FORMATIVE CHECK (during guided practice)
  Check:      [FILL: e.g. one mini-whiteboard problem]
  Proceed if: [FILL: e.g. >=80% correct]
