...
1. The research question, restated until the user confirms it. Ambiguity here multiplies through every later step.
2. What decision or output the research feeds. A brief informing a purchase differs from one informing a publication.
3. Scope boundaries: geography, industry, population, and what is explicitly out of scope.
4. Depth and deadline. Default: 3-6 sub-questions, at least two independent sources per sub-question.
5. Known sources or prior work to build on. Treat supplied sources as leads to appraise, not settled evidence.
