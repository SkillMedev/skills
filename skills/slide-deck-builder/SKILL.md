...
Good (each headline a claim, and the sequence is the argument):
1. Support tickets doubled in two quarters while headcount stayed flat
2. Manual triage is the bottleneck: 60% of agent time goes to routing, not solving
3. Auto-triage cuts routing time to near zero in the three teams that piloted it
...
- The three spine questions are answered in writing before slide one exists.
- Reading only the headlines, in order, delivers the complete argument.
- No live slide exceeds one idea or 40 words of body.
- The final slide is the ask, stated as a specific decision or action.
- The slide count fits the meeting length at ~2 minutes per slide.
